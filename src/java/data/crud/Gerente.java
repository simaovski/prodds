...
@NamedQueries({
    ...
    @NamedQuery(name = "Gerente.findByIdprojeto", query = "SELECT g FROM Gerente g WHERE g.idprojeto = :idprojeto")})
public class Gerente implements Serializable {
    ...
    @JoinColumn(name = "idusuarioadm", referencedColumnName = "id")
    @ManyToOne
    private Usuario idusuarioadm;
    ...
    public Usuario getIdusuarioadm() {
        return idusuarioadm;
    }

    public void setIdusuarioadm(Usuario idusuarioadm) {
    ...
    public String toString() {
        return "data.crud.Gerente[ id=" + id + " ]";
    }
